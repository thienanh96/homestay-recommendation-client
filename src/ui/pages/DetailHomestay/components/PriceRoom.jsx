...
export default class PriceRoom extends React.Component {

    render() {
        const { content, customStyle } = this.props;
        console.log('TCL: PriceRoom -> render -> content', content)
        ...
        const dataTable = content.data.map((el, index) => {
            return {
                ...
                column1: <div style={{ color: 'black',marginTop: '10px',fontSize: '18px' }}>{el[Object.keys(el)[0]]}</div>
            }
        })
